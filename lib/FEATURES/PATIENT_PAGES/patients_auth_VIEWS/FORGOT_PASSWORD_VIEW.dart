...
class patient_FORGOT_PASSWROD_VIEW extends ConsumerStatefulWidget {
  const patient_FORGOT_PASSWROD_VIEW({super.key});

  @override
  ConsumerState<patient_FORGOT_PASSWROD_VIEW> createState() =>
      _FORGOT_PASSWROD_VIEWState();
}

class _FORGOT_PASSWROD_VIEWState
    extends ConsumerState<patient_FORGOT_PASSWROD_VIEW> {
            ...
            TextButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => const patient_login_view_page(),
                  ));
                },
                style: TextButton.styleFrom(
                    foregroundColor: Colors.white,
